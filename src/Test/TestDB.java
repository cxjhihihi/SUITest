...
public class TestDB {
	...
	public static String url = "jdbc:mysql://localhost:3308/plusoft_test?useUnicode=true&characterEncoding=GBK";
...
//	public static String pwd = ""; 	
    ...
    public HashMap SearchEmployees(String key, int index, int size, String sortField, String sortOrder) throws Exception
    {
    	...
    	String sql = 
 "select a.* from t_employee a \n"

+"where a.loginname like '%" + key + "%' \n";
